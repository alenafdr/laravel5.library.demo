...
@section('content')
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Новая выдача</li>
    </ol>
    
    <div class="panel panel-info">
      <div class="panel-heading">
        <h3 class="panel-title">Создание выдачи</h3>
      </div>
    ...
    {!! Form::open(array('route' => 'books-in-hand.store','method'=>'POST')) !!}
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                {!! Form::text('take_at', \Carbon\Carbon::now(), array('placeholder' => 'Дата выдачи','class' => 'form-control')) !!}
            </div>
        </div>
